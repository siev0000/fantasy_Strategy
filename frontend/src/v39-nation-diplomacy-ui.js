...
.v39-diplomacy-list{display:grid;gap:6px}.v39-diplomacy-row{display:grid;grid-template-columns:minmax(100px,1fr) minmax(160px,1.5fr) 72px;align-items:center;gap:8px;border:1px solid #374b52;border-radius:8px;background:#121e23;padding:7px}.v39-diplomacy-row div{display:grid;gap:2px}.v39-diplomacy-row strong{font-size:15px}.v39-diplomacy-row span,.v39-diplomacy-row small{font-size:13px;color:#9eb1b5}.v39-diplomacy-row b{font-size:13px}.v39-diplomacy-row b.war{color:#ff927c}.v39-diplomacy-row b.peace{color:#7fd5a0}.v39-diplomacy-row button{border-color:#8a6842}
